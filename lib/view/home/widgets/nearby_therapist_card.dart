          ...
          child: InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(20.r),
                border: Border.all(color: Color(0xfFFAE08C).withAlpha(100  )),
              ),
              child: Icon(
                isFavorite ? Icons.favorite : Icons.favorite_border,
                color: isFavorite ? Color(0xffBD3D44) : Color(0xffBD3D44),
                size: 20.sp,
              ),
            ),
          ),
        ...
        CarouselSlider.builder(
          ...
          itemBuilder: (context, index, realIndex) {
            ...
            return TherapistCard(
              ...
              onTap: () {
                // Handle booking
                debugPrint('Book ${therapist['name']}');
              },
              onFavoriteTap: () {
                setState(() {
                  therapists[index]['isFavorite'] =
                      !therapists[index]['isFavorite'];
                });
              },
            );
